...
class COCOEvaluator(DatasetEvaluator):
    ...
    def _eval_predictions(self, predictions, img_ids=None):
        ...
        for task in sorted(tasks):
            ...
            if coco_eval is None:
                self._logger.warn(f"[COCOEvaluator] No predictions to evaluate for task '{task}'. Skipping.")
                self._results[task] = {}
                continue  
    ...
    def _derive_coco_results(self, coco_eval, iou_type, class_names=None):
        ...
        print("changdu:",len(coco_eval.stats))
...
def _evaluate_predictions_on_coco(
    ...
    coco_eval.summarize()
    category_index = ["pedestrian","rider","car","truck" ,"bus","train","motorcycle","bicycle","traffic light","traffic sign"]
